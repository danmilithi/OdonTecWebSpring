...
public class PacienteController {
    ...
    public String listar(@RequestParam(defaultValue = "") String busca, Model model) {
        prepararPagina(model, new Paciente(), busca);
        return "pacientes";
    }
    ...
    public String excluir(@PathVariable Integer id, RedirectAttributes redirectAttributes) {
        service.excluir(id);
        redirectAttributes.addFlashAttribute("sucesso", "Paciente excluido com sucesso.");
        return "redirect:/pacientes";
    }

    private void prepararPagina(Model model, Paciente paciente, String busca) {
